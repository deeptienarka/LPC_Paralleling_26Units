...
#pragma CODE_SECTION(InitSysCtrl, "Critical_Section");
#pragma CODE_SECTION(ServiceDog, "Critical_Section");
#pragma CODE_SECTION(DisableDog, "Critical_Section");
#pragma CODE_SECTION(InitPll, "Critical_Section");
#pragma CODE_SECTION(InitPll2, "Critical_Section");
#pragma CODE_SECTION(InitPeripheralClocks, "Critical_Section");
#pragma CODE_SECTION(CsmUnlock, "Critical_Section");
#pragma CODE_SECTION(IntOsc1Sel, "Critical_Section");
#pragma CODE_SECTION(IntOsc2Sel, "Critical_Section");
#pragma CODE_SECTION(XtalOscSel, "Critical_Section");
#pragma CODE_SECTION(ExtOscSel, "Critical_Section");
...
//   IntOsc1Sel();
	...
	// Select Crystal as the clock source
	XtalOscSel();
...
// GpioCtrlRegs.GPAMUX2.bit.GPIO18 = 3;  // GPIO18 = XCLKOUT
   SysCtrlRegs.LOSPCP.all = 0x0002;		 // Set to 90MHz/4 = 22.5Mhz
